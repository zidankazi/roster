...
export function ClaudePrompt({
  ...
  return (
    <div className={cn("min-w-0 font-mono text-[12px] leading-[1.6]", className)}>
      {e ? (
        <div
          className="flex justify-end px-1 pb-1 text-[10px]"
          style={{ color: GRAY }}
        >
      ...
      <div className="mt-1.5 min-w-0 break-words px-1 text-[10px]">
